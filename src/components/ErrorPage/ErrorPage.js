...
const ErrorPage = () => {
    return (
        <div>
            <section className="flex items-center h-full p-16 bg-red-600 dark:bg-gray-900 dark:text-gray-100 text-white">
                <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                    <div className="max-w-md text-center">
                        ...
                        <p className="mt-4 mb-8 dark:text-gray-400"> Go homepage</p>
