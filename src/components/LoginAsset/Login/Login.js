        ...
        <div className='py-16'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl  text-black mx-auto border shadow-lg">
                ...
                <form onSubmit={signInfromHandel} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="block w-full btn p-3 text-center rounded-sm text-white bg-red-600">Sign in</button>
                </form>
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button aria-label="Log in with GitHub" onClick={handelGithubSignin} className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <p className="text-xs text-center sm:px-6 text-black">Don't have an account?
                    <Link to='/register' rel="noopener noreferrer" href="#" className="underline text-black">Sign up</Link>
                </p>
            </div>
        </div>
    );
