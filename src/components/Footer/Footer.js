...
const Footer = () => {
    return (
        <div>
            <footer className="px-2 divide-y bg-gray-800 text-gray-100 lg:pt-20">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">E-GRAPHICES IT</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<a rel="noopener noreferrer" href="#">Course</a>
					</li>
					<li>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-50">E Graphices IT</h3>
				<ul className="space-y-1">
					<li>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 1968  Company Co. All rights reserved by Rony.</div>
</footer>
        </div>
    );
};
